...
<div class="frame">
    ...
    <form action="{{ route('createRessource')}}" method="POST" class="needs-validation" novalidate>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="name" id="nom" value="{{ old('name') }}" pattern=".{2,50}" required >
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="localisation" id="localisation" value="{{ old('localisation') }}" pattern=".{2,50}" required >
            <div class="valid-feedback">
              Semble bon! 
            </div>
